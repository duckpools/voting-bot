...
from helpers.serializer import encode_long, encode_long_tuple, bad_encode_coll_coll_byte


def initiation_action(token, counter_box, address, isParams, byteData, initiate=False, recipient="", params= [0], proportion=0.0001, amount_funded=0, funded_boxId=None, paying_boxId=None):
    if initiate:
        if not funded_boxId:
                ...
                "requests": [
                    {
                        ...
                        "registers": {
                            ...
                            "R7": bad_encode_coll_coll_byte(byteData)
                        }
                    }
                ],
                "fee": 1000000,
        ...
        if isParams:
            registers = {
                            ...
                            "R6": recipient,
                            "R7": encode_long_tuple([0, amount_funded, 0]),
                            "R8": bad_encode_coll_coll_byte(byteData)
                        }
